...
################################################################
# This is a generated script based on design: clk_design
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set clk_250_mhz [ create_bd_port -dir O -type clk clk_250_mhz ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {250000000} \
 ] $clk_250_mhz
  set clk_25_mhz [ create_bd_port -dir O -type clk clk_25_mhz ]
  set_property -dict [ list \
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_ports clk_25_mhz] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_ports clk_250_mhz] [get_bd_pins clk_wiz_0/clk_out2]
